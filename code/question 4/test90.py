...
if __name__ == '__main__':
    ...
    img1 = cv2.imread('./data/90.png')

    horizontal_point = [[162, 452], [106, 507], [839, 600], [821, 526]]

    dian4_h = horizontal_point
    ...
    line1 = (dian4_h[0],dian4_h[1])
    line2 = (dian4_h[2],dian4_h[3])
    crosspoint1_h = get_crosspoint(line1, line2)
    print('crosspoint1',crosspoint1_h)
    crosspoint1_int_h = (int(crosspoint1_h[0]),int(crosspoint1_h[1]))
    img1 = cv2.circle(img1, (int(crosspoint1_h[0]),int(crosspoint1_h[1])), 5, (255, 0, 0), -1)

    line3 = (dian4_h[0],dian4_h[3])
    line4 = (dian4_h[1],dian4_h[2])
    crosspoint2_h = get_crosspoint(line3, line4)
    crosspoint2_int_h = (int(crosspoint2_h[0]), int(crosspoint2_h[1]))
    print('crosspoint2',crosspoint2_h)
    img1 = cv2.circle(img1, (int(crosspoint2_h[0]), int(crosspoint2_h[1])), 5, (255, 0, 0), -1)
    ...
    vp0 = get_crosspoint(line_cross_h, (wall_point1, wall_point4))
    x1 = [12, 495]
    x2 = [106, 507]
    ...
    dis = 12
    distance_3 = dis / cr
    print('distance 墙3:',distance_3,cr)
    ...
    dis = 12
    distance_4 = dis / cr
    print('distance 墙4:',distance_4,cr)
    ...
    dis = 12
    distance_5 = dis / cr
    print('distance 墙5:',distance_5,cr)
    ...
    dis = 12
    distance_6 = dis / cr
    print('distance 墙6:',distance_6,cr)

    print('全长:', distance_4)
    print('前厅:', distance_3-12)
    print('大门:', distance_6 - distance_5)
